...
INSERT INTO `invitation` (`id`, `date`, `status`, `user_id`, `event_id`) VALUES
(1,	'2019-03-10 02:55:05',	1,	4,	1),
(2,	'2023-03-10 02:55:07',	NULL,	2,	1),
(3,	'2023-03-10 02:55:07',	NULL,	2,	1);


INSERT INTO `user` (`id`, `name`, `firstname`, `email`, `password`, `status`) VALUES
(1,	'Jomaa',	'Akrem',	'akrem@gmail.com',	'akrem',	1),
(2,	'Zidane',	'Wail',	'wail@gmail.com',	'wail',	NULL),
(3,	'Boukhdir',	'khaoula',	'khaoula@gmail.com',	'khaoula',	NULL),
